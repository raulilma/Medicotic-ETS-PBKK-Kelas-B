    ...
    <body class="antialiased">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-danger">
            <div class="container-fluid">
              <a class="navbar-brand text-light" href="#">Medicotic</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="flex justify-center">
                            <img src="img/medicotic.png" alt="Logo Medicotic" width="250" title="Logo Gameku">
                        </div>
                        <div class="card mt-3">
                            <div class="card-body">
                                <h4 class="text-center font-weight-bold">Formulir Baru | Medicotic</h4>
                                <div class="text-center font-semibold text-gray-1000 text-sm">ETS PBKK B</div>
                                ...
                                <form action="/proses-tugas" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="form-group">
                                                <label for="pasien" class="font-weight-bold">Pasien</label>
                                                <select name="pasiens" id="" class="form-control">
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="dokter" class="font-weight-bold">Dokter</label>
                                                <select name="dokters" id="" class="form-control">
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="kondisi" class="font-weight-bold">Kondisi Kesehatan</label>
                                            ...
                                            <div class="form-group">
                                                <label for="suhu" class="font-weight-bold">Suhu Tubuh</label>
                                            ...
                                            <div class="form-group">
                                                <label for="resep" class="font-weight-bold">File/Gambar Resep</label>
                                                <input class="form-control-file" id = "resep" type="file" value="{{ old('resep') }}" name="resep" accept="application/pdf,image/png, image/jpg, image/jpeg" class="@error('resep') is-invalid @enderror"/>
                                                @error('resep')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <input type="submit" class="btn btn-danger btn-block" value="Proses"/>
                                </form>
